...
void __fastcall TMainF::Translate()
{
    ...
    M_Debug_TraceLevel0->Caption=Prefs->Translate(__T("Trace level - 0")).c_str();
    M_Debug_TraceLevel50->Caption=Prefs->Translate(__T("Trace level - 5")).c_str();
    M_Debug_TraceLevel90->Caption=Prefs->Translate(__T("Trace level - 9")).c_str();
    M_Debug_TraceLevel100->Caption=Prefs->Translate(__T("Trace level - 10")).c_str();
