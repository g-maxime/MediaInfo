//
// SheetViewEditFieldControl.xaml.cpp
// Implementation of the SheetViewEditFieldControl class
//
...
SheetEditFieldControl::SheetEditFieldControl(Platform::String^ Name, size_t Width, size_t StreamKind, Platform::String^ Parameter)
{
    InitializeComponent();
    ...
    NameText->Text=Name;
    SizeText->Text=ref new Platform::String(Ztring().From_Number(Width).c_str());
...
{
    return Ztring(SizeText->Text->Data()).To_int32u();
}
