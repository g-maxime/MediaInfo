...
namespace MediaInfo
{
    ...
    {
    public:
        Field(Platform::String^ Title, uint32 StreamKind, Platform::String^ Parameter, uint32 Length) : _Title(Title), _StreamKind(StreamKind), _Parameter(Parameter), _Length(Length) {};
